...
const ReservationInfoModal = () => {
  ...
  return (
    <div className="w-[429px] rounded-3xl border border-[#DDD] bg-white p-6 text-black200">
      ...
      <div className="mt-8">
        ...
        <div className="h-[286px] overflow-scroll mt-4">
      ...
      <div className="mt-5 flex justify-between text-[24px] font-semibold font-black200">
        <p>예약 현황</p>
        <p>5</p>
      </div>
    </div>
