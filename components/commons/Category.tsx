...
const Category = ({ onClick, isSelected, children }: CategoryType) => {
  return (
    <div
      className={`flex justify-center items-center w-[12.7rem] h-[5.3rem] border border-solid border-green200 rounded-[15px] font-family text-[1.8rem] font-medium cursor-pointer ${
