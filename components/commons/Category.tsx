...
const Category = ({ onClick, isSelected, children }: CategoryType) => {
  return (
    <div
      className={`flex justify-center items-center w-[12.7rem] h-[5.3rem] border border-solid border-green200 rounded-[1.5rem] bg-white font-family text-[1.8rem] font-medium cursor-pointer ${
