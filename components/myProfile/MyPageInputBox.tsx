...
const MyPageInputBox = ({
  ...
  return (
    <div className="flex flex-col text-black200 max-w-[792px]">
      <MyPageInputLabel labelName={labelName} />
      <input
        className={`w-full text-[1rem] text-black200 flex py-4 pl-5 border h-14 border-gray400 rounded ${borderColorClass}`}
        type={inputType}
        id={inputName}
